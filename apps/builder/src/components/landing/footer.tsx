...
export function LandingFooter() {
  return (
    <footer className="bg-ink text-slate-400 py-16 border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs">
              <li><Link href="/signup" className="text-indigo-300 hover:text-indigo-200 font-bold">Create Free Account →</Link></li>
